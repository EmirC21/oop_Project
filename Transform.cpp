...
{
	transMatrix(0, 0) = rotationmatrix[0][0];
	transMatrix(0, 1) = rotationmatrix[0][1];
	transMatrix(0, 2) = rotationmatrix[0][2];
	transMatrix(1, 0) = rotationmatrix[1][0];
	transMatrix(1, 1) = rotationmatrix[1][1];
	transMatrix(1, 2) = rotationmatrix[1][2];
	transMatrix(2, 0) = rotationmatrix[2][0];
	transMatrix(2, 1) = rotationmatrix[2][1];
	transMatrix(2, 2) = rotationmatrix[2][2];
